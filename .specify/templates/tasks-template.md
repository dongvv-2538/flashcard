...
**Constitution Principle II (Testing Standards)**, tests are REQUIRED for all new code — unit coverage MUST reach ≥80% and integration tests MUST cover all public APIs and user-visible flows.
...
- [ ] TXXX [P] Additional unit tests to meet ≥80% coverage in tests/unit/ (Constitution Principle II)
